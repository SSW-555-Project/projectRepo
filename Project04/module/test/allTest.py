...
from test.sprint4Test import TestSprint4Func
...
if __name__ == '__main__':
    ...
    tests = [TestSprint2Func("test_isMaleLastNames"), TestSprint2Func("test_isParentsNotTooOld"),TestSprint2Func("test_US10"),TestSprint2Func("test_US15"), TestSprint2Func("test_US11_Bigamy"),
            TestSprint2Func("test_US13_Sibling_Spacing"), TestSprint2Func("test_us09"), TestSprint2Func("test_us14")]
    suite.addTests(tests)
